...
const Hero: React.FC<HeroProps> = ({ onStart, onSolutions }) => {
  return (
    <div className="relative min-h-[90vh] flex items-center justify-center pt-12 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/80 backdrop-blur-md border border-slate-700 text-blue-400 text-xs font-black uppercase tracking-widest mb-6">
            <span className="flex h-2 w-2 rounded-full bg-blue-500 animate-ping"></span>
            Vision Industrielle
          </div>

          <h1 className="text-3xl md:text-5xl lg:text-4xl font-black text-white mb-4 leading-none tracking-tighter">
          ...
          <p className="text-xs md:text-base text-slate-300 max-w-xl mx-auto mb-4 font-medium leading-relaxed">
          ...
          <div className="mt-10 flex justify-center gap-4 md:gap-16">
            <div className="text-center">
