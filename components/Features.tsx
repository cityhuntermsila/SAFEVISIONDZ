    ...
    <div className="py-24 bg-slate-900 border-t border-slate-800/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-32">
          <h2 className="text-2xl md:text-1xl font-black text-white mb-10 tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {benefits.map((benefit, i) => (
              <div key={i} className="flex flex-col items-center text-center group">
                <div className="w-18 h-18 rounded-full bg-orange-500/10 border-2 border-orange-500/20 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:border-orange-500/50 transition-all duration-300 shadow-[0_0_30px_rgba(249,115,22,0.1)]">
                  <i className={`fas ${benefit.icon} text-3xl text-orange-500`}></i>
                </div>
                <h3 className="text-1xl font-black text-white mb-3 uppercase tracking-tighter">
                  {benefit.title}
                </h3>
        ...
        <div className="flex flex-col items-center text-center mb-32 pt-24 border-t border-slate-800/30">
          <div className="max-w-4xl space-y-8 mb-16">
            ...
            <h2 className="text-4xl md:text-1xl font-black text-white leading-tight tracking-tighter uppercase">
              Détection des EPI
            </h2>
            <p className="text-xl md:text-1/8xl text-slate-400 font-medium leading-relaxed">
